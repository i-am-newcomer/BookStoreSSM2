<html>
	...
	<body>
		...
		<h4>使用的数据库表：customers、book、orders、orderitems，如下：</h4>
		<h5 align="center">customers</h5>
		<p align="center"><img alt="customers" src="images/customers.GIF"></p>
		<h5 align="center">book</h5>
		<p align="center"><img alt="book" src="images/book.GIF"></p>
		<h5 align="center">orders</h5>
		<p align="center"><img alt="orders" src="images/orders.GIF"></p>	
		<h5 align="center">orderitems</h5>
		<p align="center"><img alt="orderitems" src="images/orderitems.GIF"></p>	
	</body>
</html>